...
- In-app AI/manual reply send status: Gmail supported; Yahoo/Fastmail (IMAP providers) pending
...
- Reply send in this phase is provider-scoped: Gmail is supported in-app; Yahoo/Fastmail remain pending.
